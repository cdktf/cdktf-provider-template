...
export function dataTemplateCloudinitConfigPartToHclTerraform(struct?: DataTemplateCloudinitConfigPart | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataTemplateCloudinitConfig extends cdktf.TerraformDataSource {
  ...
  * @param importToId The construct id used in the generated config for the DataTemplateCloudinitConfig to import
  * @param importFromId The id of the existing DataTemplateCloudinitConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/template/2.2.0/docs/data-sources/cloudinit_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      part: {
        value: cdktf.listMapperHcl(dataTemplateCloudinitConfigPartToHclTerraform, true)(this._part.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataTemplateCloudinitConfigPartList",
      },
    };
